 ...
 *  to meaningful RadioMap2 files)
 *  3) The AirPlace Tracker (Ideal for using the RadioMap2 files for
 *  indoor localization)
 *
 ...
 */
public class RadioMap2 {

    private final HashMap<String, HashMap<String, ArrayList<Integer>>> RadioMap2;
    ...
    /**
     * Constructor of the RadioMap2 class
     *
     * @param rss_folder
     ...
     *
     * */
    public RadioMap2(File rss_folder, String RadioMap_filename, int defaultNaNValue) {
    ...
    private void parseLogFileToRadioMap(File inFile) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                MACAddressMap = RadioMap2.get(key);
                ...
                if (MACAddressMap == null) {
                    ...
                    RadioMap2.put(key, MACAddressMap);
                    continue;
                }
    ...
    public boolean writeParameters(String inFile) {
        ...
        File RadioMap2_parameters_file = new File(RadioMap_parameters_filename);
        try {
            fos = new FileOutputStream(RadioMap2_parameters_file, false);
        } catch (Exception e) {
            System.err.println("Error while writing parameters: " + e.getMessage());
            RadioMap2_parameters_file.delete();
            return false;
        }
    ...
    private boolean find_MIN_MAX_Values() {
        ...
        try {
            ...
            while ((RadioMap2Line = readerRadioMap2.readLine()) != null) {

                // Check X, Y or Latitude, Longitude
                if (RadioMap2Line.startsWith("#")) {
                    RadioMap2Line = RadioMap2Line.replace(", ", " ");
                    String[] temp = RadioMap2Line.split(" ");
                ...
                } else if (RadioMap2Line.trim().isEmpty()) {
                    // Ignore the labels
                    continue;
                }
    ...
    private boolean writeRadioMap() {
        ...
        if (RadioMap2.isEmpty()) {
            return false;
        }

        // Open output streams
        try {
            fos = new FileOutputStream(RadioMap2_file, false);
            fos_mean = new FileOutputStream(RadioMap2_mean_file, false);
        } catch (FileNotFoundException e) {
            System.err.println("Error while writing radio map: " + e.getMessage());
            RadioMap2_file.delete();
            RadioMap2_mean_file.delete();
            return false;
        }
        ...
        try {
            ...
            for (String Geolocation : RadioMap2.keySet()) {
                MACAddressMap = RadioMap2.get(Geolocation);
            ...
            for (String location : RadioMap2.keySet()) {
                ...
                MACAddressMap = RadioMap2.get(location);
